...
const ACT_METRICS={
 ...
 liConnDeal:{label:'LinkedIn requests (deal)',keys:['liConnDeal'],
   note:function(){return 'Connection requests sent to contacts whose company holds an open deal, attributed to the sender from the Groovin note body, counted from '+COVERAGE.linkedin_notes_covered_from+'. Prospecting requests to companies with no deal yet are not counted here. '+COVERAGE.li_pairing_note;}},
 liAccDeal:{label:'LinkedIn connections (deal)',keys:['liAccDeal'],
   note:function(){return 'Invitations accepted by contacts whose company holds an open deal, counted from '+COVERAGE.linkedin_notes_covered_from+'. Acceptances lag the request that earned them, often by weeks, so this ranking reflects earlier outreach rather than work done this quarter. Rank on requests sent to see current effort. '+COVERAGE.li_pairing_note;}},
 liMsgDeal:{label:'LinkedIn messages (deal)',keys:['liMsgDeal'],
   note:function(){return 'LinkedIn messages to contacts whose company holds an open deal, attributed from the chat-note title, deduped across the person and company copies, counted from '+COVERAGE.linkedin_notes_covered_from+'. '+COVERAGE.li_pairing_note;}},
...
function renderCoverage(){
  ...
  document.getElementById('liPairing').textContent=COVERAGE.li_pairing_note||'';
